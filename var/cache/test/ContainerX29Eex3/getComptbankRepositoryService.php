...
// Returns the private 'App\Repository\ComptbankRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptbankRepository.php';

return $this->privates['App\\Repository\\ComptbankRepository'] = new \App\Repository\ComptbankRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
