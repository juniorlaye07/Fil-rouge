...
// Returns the private 'App\Repository\DepotArgentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DepotArgentRepository.php';

return $this->privates['App\\Repository\\DepotArgentRepository'] = new \App\Repository\DepotArgentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
